...
1. install apk from this [link](https://gitlab.com/-/project/23195867/uploads/3e5994177ce852bb7bf5b74743b6d99b/LocalGSMBackend.apk)
2. download lacells.db.gz and extract using ```gunzip lacells.db.gz```
3. place ```lacells.db``` to ```/sdcard/Android/data/org.fitchfamily.android.gsmlocation/files/lacells.db```
